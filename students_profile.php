...
<body>
    ...
    <form action="save_profile.php" method="post">
       ...
       <a href="academics_details.php?id=<?php echo $student_id; ?>"><button>Academic Details</button></a>
       <a href="view_attendance.php?id=<?php echo $student_id; ?>"><button>View Attendance</button></a>
       <a href="mailto:shettyyajnesh01@gmail.com"><button>Register Complaint</button></a>
